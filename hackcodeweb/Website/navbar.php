            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMaster">
                        <li><a href="../db/enquiry.php" class="dropdown-item" ><strong>enquiry </strong></a></li>
                        <li><a href="#" class="dropdown-item" ><strong>Add</strong></a></li>
                        <li><a href="../db/admin.php" class="dropdown-item" accesskey="u"><strong>Manage User</strong></a></li>
                        <li><a href="#" class="dropdown-item" accesskey="b"><strong>Add </strong></a></li>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                        <li><a href="emp_profile.php" class="dropdown-item"><strong>name</strong></a></li>
